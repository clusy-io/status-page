...
import { uptimeColor, formatUptime } from "@/lib/present";
      ...
      >
        {days.map((d, i) => (
          <div
            ...
            style={{
              background: uptimeColor(d.uptime),
              opacity: d.uptime === null ? 0.25 : 1,
              minWidth: 2,
              outline:
        ...
        {active && (
          ...
          >
            <span className="font-medium text-[var(--text)]">
              {active.uptime === null ? "No data" : formatUptime(active.uptime)}
            </span>
